...
const LAYER_0: KeyMapLayer = [
    ...
    [   NO_SW,  LGUI,   LALT,   LALT,   DEL,    TAB,    SPACE,          ENTER,  BACKS,  BACKS,  RALT,   RALT,   RGUI,   NO_SW,  ],
    [   NO_SW,  NO_SW,  NO_SW,  NO_SW,  LANG2,  LSFT,   L2,             RSFT,   RSFT,   LANG1,  NO_SW,  NO_SW,  NO_SW,  NO_SW,  ],
];
